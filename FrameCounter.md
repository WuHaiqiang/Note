...
public class FrameCounter : MonoBehaviour 
{
	...
	void OnGUI()
	{
		...
		GUI.Label(new Rect(1700,50,300,50), guic);
		//GUI.Label(new Rect(1500,30,300,50), "WASD to move, left shift for speed");
		//GUI.Label(new Rect(1500,50,300,50), "Right click rotate");
		//GUI.Label(new Rect(1500,70,300,50), "'C' to toggle Scion");
