...
public class GyroController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (this.gyroEnabled )
        {
            base.transform.localRotation = Quaternion.Slerp(base.transform.localRotation, this.cameraBase * (ConvertRotation(this.referanceRotation * Input.gyro.attitude) * this.GetRotFix()), 1f);//0.1f
        }
    }
